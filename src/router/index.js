...
export const constantRouterMap = [
  ...
  // 学生管理 student management
  {
    ...
    children: [
      ...
      {
        path: 'essential-info',
        component: () => import('@/views/studentm/essential-info'),
        name: 'EssentialInformation',
        meta: { title: '基本信息', icon: 'essential-info' }
      },
      // 推荐课程管理 Course Recommended Management
      {
        path: 'course-recommendedm',
        component: () => import('@/views/studentm/course-recommendedm'),
        name: 'CourseRecommendedManagement',
        meta: { title: '推荐课程管理', icon: 'course-recommendedm' }
      }
    ]
  },
  /* {
