...
<!--      <h3>{{newScale}}</h3>-->
    ...
    >
      ...
      >
        ...
        <el-button  type="primary" @click="addFactorScoreDescription(factor)">添加因子得分解释</el-button>
      </el-form-item>
      <el-form-item>
      ...
      <el-form-item>
        <el-button  type="primary" @click="addScoreDescription">添加总分解释</el-button>
      </el-form-item>
    </el-form>
    <div slot="footer" class="dialog-footer" >
      ...
      <el-button type="danger" @click="cancelScale()">
        取消
      </el-button>
    </div>
  </div>
...
<script>
  import { fetchList,  submitScale, saveScale, fetchSavedScaleByScaleId,  } from '@/api/scale'
