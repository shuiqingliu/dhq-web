...
<script>
  import {fetchList, deleteEquipmentType} from '@/api/equipmentType'
  ...
  export default {
    ...
    methods: {
      ...
      handleUpdate(index, row) {
        this.$router.push({path: '/equipment/updateEquipmentType', query: {id: row.id}})
      },
      //删除
