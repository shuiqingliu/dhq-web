    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column label="操作" width="150" align="center" >
          <template slot-scope="scope">
            <el-button size="mini" type="danger" @click="rejectApply(scope.$index, scope.row)" :disabled="!(scope.row.resultDes == null || scope.row.resultDes == '')">拒绝</el-button>
            <el-button size="mini" type="success" @click="handleApply(scope.$index, scope.row)" :disabled="!(scope.row.resultDes == null || scope.row.resultDes == '')">处理</el-button>
          </template>
        </el-table-column>
      </el-table>
